...
<html lang="fr" dir="ltr">
  ...
  <body>
    <form action="verification_inscription.php" method="post" enctype="multipart/form-data">
      <input type="text" name="pseudo" class="form-control" placeholder="Saisir votre pseudo"><br>
      <input type="email" name="email" class="form-control" placeholder="Saisir votre email"><br>
      ...
      <input type="submit" name="submit" class="btn btn-secondary" value="Inscription">
    </form>
  </body>
  <?php
